...
<<<<<<< HEAD
                <input type="text" id="name" name="name" className="w-full bg-transparent outline-none text-white text-base peer placeholder-transparent" placeholder="Your Name" suppressHydrationWarning />
              ...
              <div className="relative border-b border-gray-700 focus-within:border-blue-500 pb-2">
                <input type="email" id="email" name="email" className="w-full bg-transparent outline-none text-white text-base peer placeholder-transparent" placeholder="Your Email" suppressHydrationWarning />
=======
...
>>>>>>> 792cb8520518d6091513d49a2301aa8948dada66
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="relative border-b border-gray-700 focus-within:border-blue-500 pb-2">
<<<<<<< HEAD
                <input type="text" id="phone" name="phone" className="w-full bg-transparent outline-none text-white text-base peer placeholder-transparent" placeholder="Phone Number" suppressHydrationWarning />
              ...
              <div className="relative border-b border-gray-700 focus-within:border-blue-500 pb-2">
                <input type="text" id="country" name="country" className="w-full bg-transparent outline-none text-white text-base peer placeholder-transparent" placeholder="Country" suppressHydrationWarning />
=======
...
>>>>>>> 792cb8520518d6091513d49a2301aa8948dada66
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="relative border-b border-gray-700 focus-within:border-blue-500 pb-2">
<<<<<<< HEAD
                <input type="text" id="company" name="company" className="w-full bg-transparent outline-none text-white text-base peer placeholder-transparent" placeholder="Company Name" suppressHydrationWarning />
              ...
              <div className="relative border-b border-gray-700 focus-within:border-blue-500 pb-2">
                <select id="interested" name="interested" className="w-full bg-transparent outline-none text-white text-base peer placeholder-transparent appearance-none" defaultValue="" suppressHydrationWarning>
=======
...
>>>>>>> 792cb8520518d6091513d49a2301aa8948dada66
            ...
            <div className="relative border-b border-gray-700 focus-within:border-blue-500 pb-2">
<<<<<<< HEAD
              <textarea id="message" name="message" rows={3} className="w-full bg-transparent outline-none text-white text-base peer placeholder-transparent resize-none" placeholder="Message" suppressHydrationWarning></textarea>
            ...
            <button type="submit" className="mt-8 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-full transition-colors duration-300 flex items-center gap-2" suppressHydrationWarning>
=======
