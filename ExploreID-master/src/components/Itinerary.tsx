    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-6 right-6 bg-blue-400 hover:bg-blue-500 text-white py-3 px-6 rounded-full shadow-lg flex items-center gap-2 font-bold transition duration-300 z-[20]"
        >
